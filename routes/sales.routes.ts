...
import { GoldType, CurrencyType } from "@/lib/generated/prisma";
    ...
    .post("/store/:storeId",
        ...
        async (c) => {
            ...
            try {
                ...
                const currentGoldBalance = await getStoreGoldBalance(store!, goldType);
                ...
                const currentPrices = await getCurrentPrices(store!);
